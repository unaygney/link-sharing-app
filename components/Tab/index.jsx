...
export default function Tab({ active = false, onClick, className }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={clsx(
        "flex justify-center items-center gap-2 px-7 py-3 max-w-[120px] heading-s rounded-lg hover:text-purple",
        active && "bg-very-light-purple text-purple",
